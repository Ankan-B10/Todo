	...
	return (
		<div className="bg-white place-self-center w-11/12 max-w-md flex flex-col p-7 min-h-[550px] rounded-xl">
			...
			<div className="flex items-center my-7 bg-gray-200 rounded-full">
				<input
					ref={inputRef}
					className="bg-transparent border-0 outline-none flex-1 h-14 pl-6 pr-2 placeholder:black-400
                    "
					type="text"
				...
				<button
					onClick={add}
					className="border-none rounded-full bg-orange-600 text-white w-32 h-14 text-lg cursor-pointer">
					ADD +
				</button>
			</div>
			...
			<div className="flex justify-center mt-3">
				<button
					onClick={markAllDone}
					className="border-none rounded-full bg-green-500 text-white w-32 h-10  cursor-pointer">
					Mark all done
				</button>
			</div>
		</div>
